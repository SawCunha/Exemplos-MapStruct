...
public class ConversaoComModificacaoDeDadosDoEntityParaDto {


    private static final Faker FAKER = new Faker();
    public static void main(String[] args) {

        PessoaMapperExemplo3 pessoaMapperExemplo3 = PessoaMapperExemplo3.INSTANCIA;
        Pessoa pessoa = criaPessoa();

        PessoaDTO pessoaDTO = pessoaMapperExemplo3.pessoaParaPessoaDTO(pessoa);

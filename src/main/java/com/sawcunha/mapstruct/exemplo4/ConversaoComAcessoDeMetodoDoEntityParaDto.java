...
public class ConversaoComAcessoDeMetodoDoEntityParaDto {


    private static final Faker FAKER = new Faker();
    public static void main(String[] args) {

        PessoaMapperExemplo4 pessoaMapperExemplo4 = PessoaMapperExemplo4.INSTANCIA;
        Pessoa pessoa = criaPessoa();

        PessoaDTO pessoaDTO = pessoaMapperExemplo4.pessoaParaPessoaDTO(pessoa);

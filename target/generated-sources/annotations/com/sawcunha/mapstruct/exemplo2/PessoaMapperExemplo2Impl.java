...
public class PessoaMapperExemplo2Impl implements PessoaMapperExemplo2 {

    private final TelefoneMapperExemplo2 telefoneMapperExemplo2 = Mappers.getMapper( TelefoneMapperExemplo2.class );
    ...
    protected List<TelefoneDTO> telefoneListToTelefoneDTOList(List<Telefone> list) {
        ...
        for ( Telefone telefone : list ) {
            list1.add( telefoneMapperExemplo2.telefoneParaTelefoneDTO( telefone ) );
        }

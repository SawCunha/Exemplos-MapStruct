...
public class PessoaMapperExemplo4Impl implements PessoaMapperExemplo4 {

    private final TelefoneMapperExemplo4 telefoneMapperExemplo4 = Mappers.getMapper( TelefoneMapperExemplo4.class );
    ...
    protected List<TelefoneDTO> telefoneListToTelefoneDTOList(List<Telefone> list) {
        ...
        for ( Telefone telefone : list ) {
            list1.add( telefoneMapperExemplo4.telefoneParaTelefoneDTO( telefone ) );
        }
